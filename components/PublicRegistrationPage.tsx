...
export const PublicRegistrationPage: React.FC<PublicRegistrationPageProps> = ({ onRegister, onBackToLogin }) => {
  ...
  return (
    <div className="bg-slate-800 p-8 rounded-lg shadow-lg">
        <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-center text-gray-400 mb-6">Complete your registration to join the commons.</p>
        </div>
